...
/**
 * @file
 * Contains \Drupal\Tests\odsg_migrate\Unit\process\OdsgCleanHtmlTest.
 */

namespace Drupal\Tests\odsg_migrate\Unit\process;

use Drupal\migrate\MigrateException;
use Drupal\Tests\migrate\Unit\process\MigrateProcessTestCase;
use Drupal\odsg_migrate\Plugin\migrate\process\OdsgCleanHtml;

/**
 * Tests the ODSG Clean HTML process plugin.
 *
 * @group migrate
 */
class OdsgCleanHtmlTest extends MigrateProcessTestCase {

  /**
   * {@inheritdoc}
   */
  protected function setUp() {
    $this->plugin = new TextOdsgCleanHtml();
    parent::setUp();
  }

  /**
   * Test ODSG clean HTML fixes heading hierarchy.
   */
...
EOT;
  ...
  /**
   * Test ODSG clean HTML removes empty nodes.
   */
...
EOT;
  ...
  /**
   * Test ODSG clean HTML removes unncessary strong tags.
   */
...
EOT;
  ...
  /**
   * Test ODSG clean HTML removes unwanted line breaks.
   */
...
EOT;
  ...
  /**
   * Test ODSG clean HTML fixes tables.
   */
...
EOT;
  ...
  /**
   * Test ODSG clean HTML fails properly on non-arrays.
   */
...
/**
 * Test class for ODSG Clean HTML process.
 */
class TextOdsgCleanHtml extends OdsgCleanHtml {
